...
if (document.getElementById('b20in')) {
  ...
  function convertFromB10() {
    ...
    if (isNaN(val)) {
      ...
      b10hint.className   = 'hint';
      b10in.className     = 'error';
      clearConv(); return;
    }
...
if (document.getElementById('motherIn')) {
  ...
  function validateParent(inputEl, hintEl, notation) {
    ...
    const val = parseB20(str, notation);
    if (val === null) {
      hintEl.textContent = 'Invalid input';
  ...
  function computeAverage() {
    ...
    if (m === null || f === null) {
      ...
      childCompact.textContent = '—';
      childCsv.textContent     = '—';
      childDec.textContent     = '—';
      if (m === null) motherDec10.textContent = '—';
      if (f === null) fatherDec10.textContent = '—';
      return;
    }
    const avg  = (m + f) / 2;
